      ...
      {show ? (
        ...
        >
          ...
          <motion.div
            ...
            className="panel-3d relative w-[92%] max-w-sm p-6"
          >
            ...
            <div className="mt-4 h-2 w-full overflow-hidden bg-slate-900/10 dark:bg-white/10">
              <motion.div
                className="h-full w-1/2 bg-slate-900/60 dark:bg-white/60"
                initial={{ x: "-100%" }}
                animate={{ x: "200%" }}
